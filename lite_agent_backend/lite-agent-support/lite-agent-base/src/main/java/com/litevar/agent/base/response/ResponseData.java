...
public class ResponseData<T> {
	...
	public static <T> ResponseData<T> error(T data) {
		return success(ServiceExceptionEnum.OPERATE_FAILURE.getCode(), ServiceExceptionEnum.OPERATE_FAILURE.getMessage(), data);
	}

	public static <T> ResponseData<T> of(ServiceExceptionEnum exceptionEnum) {
		return new ResponseData<>(exceptionEnum.getCode(), exceptionEnum.getMessage(), null);
	}
