package com.litevar.agent.rest.executor;
...
public class StoreMessageExecutor {
    ...
    public static void store(String sessionId, String requestId, OutMessage messages) {
    ...
    public void store(String sessionId) {
        ...
        Map<String, List<OutMessage>> taskMessageMap = list.stream()
                .collect(Collectors.groupingBy(RequestMessage::requestId,
                        Collectors.mapping(RequestMessage::messages, Collectors.toList())));
    ...
    private record RequestMessage(String requestId, OutMessage messages) {
    }
}
