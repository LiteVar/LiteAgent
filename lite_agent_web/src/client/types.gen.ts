...
export type LocalAgentInfoDTO = {
   ...
   * 方法列表
   */
  toolFunctionList?: Array<FunctionVO>;
  /**
   * 子agent(普通,分发,分思) id
   */
  subAgentIds?: Array<string>;
...
export type GetV1ChatAudioSpeechData = {
  headers: {
    /**
     * 认证 Token
     */
...
export type GetV1ChatAudioSpeechResponse = {
  [key: string]: unknown;
};

export type GetV1ChatAudioSpeechError = unknown;
...
export type GetV1PhoneHasBindData = {
  headers: {
    /**
     * 认证 Token
     */
...
export type GetV1PhoneHasBindResponse = ResponseDataBoolean;

export type GetV1PhoneHasBindError = unknown;

export type PostV1PhoneSendSmsData = {
  headers: {
    /**
     * 认证 Token
     */
...
export type PostV1PhoneSendSmsResponse = ResponseDataString;

export type PostV1PhoneSendSmsError = unknown;

export type PostV1PhoneVerifyCodeData = {
  headers: {
    /**
     * 认证 Token
     */
...
export type PostV1PhoneVerifyCodeResponse = ResponseDataBoolean;

export type PostV1PhoneVerifyCodeError = unknown;

export type PostV1PhoneBindData = {
  headers: {
    /**
     * 认证 Token
     */
...
export type PostV1PhoneBindResponse = ResponseDataString;

export type PostV1PhoneBindError = unknown;

export type PostV1PhoneRebindData = {
  headers: {
    /**
     * 认证 Token
     */
...
export type PostV1PhoneRebindResponse = ResponseDataString;

export type PostV1PhoneRebindError = unknown;

export type GetV1RegisterPicCaptchaResponse = ResponseDataPictureCaptchaResponse;
...
export type $OpenApiTs = {
  ...
  '/v1/register/picCaptcha': {
    get: {
      res: {
        '200': ResponseDataPictureCaptchaResponse;
      };
    };
  };
