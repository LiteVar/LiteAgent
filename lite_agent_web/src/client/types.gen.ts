...
export type GetApiChatbotV1DeviceListData = {
  headers?: {
    Authorization?: string;
  };
};

export type GetApiChatbotV1DeviceListResponse = {
  [key: string]: unknown;
};

export type GetApiChatbotV1DeviceListError = unknown;
...
export type $OpenApiTs = {
  ...
  '/api/chatbot/v1/device/list': {
    get: {
      req: GetApiChatbotV1DeviceListData;
      res: {
        /**
         * 成功
         */
