...
const LogItem: React.FC<LogItemProps> = ({ item, index, onKnowledgeClick }) => {
  ...
  return (
    <div className="border border-gray-300 rounded-xl mb-2 break-all break-words">
      <div className="flex items-center gap-4 p-4 rounded-t-xl text-sm text-gray-500 bg-white/60">
