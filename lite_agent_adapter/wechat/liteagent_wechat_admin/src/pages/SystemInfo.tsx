...
export default function SystemInfo() {
  ...
  return (
    <>
      <PageMeta
        title="系统信息 | LiteAgent Wechat Admin"
        ...
        <div className="col-span-12 md:col-span-6">
          <div className="rounded-lg border border-stroke bg-white p-6 shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <span className="text-black dark:text-white">微信API:</span>
                <span className="inline-flex rounded-full bg-success bg-opacity-10 px-3 py-1 text-sm font-medium text-success">
                  正常
                </span>
              </div>
            ...
            {loading ? (
              ...
              <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
                <div className="rounded-lg bg-gray-2 p-4 dark:bg-meta-4">
                  <div className="text-2xl font-bold text-primary">{stats.wechatAccounts}</div>
                  <div className="text-sm text-black dark:text-white">公众号数量</div>
                </div>
                <div className="rounded-lg bg-gray-2 p-4 dark:bg-meta-4">
