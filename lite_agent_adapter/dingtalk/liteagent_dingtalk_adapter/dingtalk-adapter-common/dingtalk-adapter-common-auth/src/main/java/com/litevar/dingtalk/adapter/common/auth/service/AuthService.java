package com.litevar.dingtalk.adapter.common.auth.service;
...
import com.litevar.dingtalk.adapter.common.core.config.DingtalkAdapterAdminProperties;
...
public class AuthService {
    ...
    private final DingtalkAdapterAdminProperties adminProperties;
    ...
    public SaTokenInfo adminLogin(String username, String password) {
        ...
        if(StrUtil.equals(username,adminProperties.getUsername())
            ...
            LoginUtil.login(loginUser,null);
